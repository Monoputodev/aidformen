...
class GeneralPagesController extends Controller
{
    ...
    {   
        ...
        $data = GeneralPages::where('status','active')->paginate(30);
    ...
    public function destroy($id)
    {
        ...
        try {
            // Category update
             $imagePath = $this->generalpages_path.'/'.$model->image_link;
    ...
    public function search(Request $request)
    {
        ...
        if($this->isGetRequest())
        {
            ...
            $data = $model->whereIn('tag',['about-us','others','project','quote'])->select('general_pages.*')->paginate(30);
        }else{

            // If get data not found
            $data = GeneralPages::whereIn('tag',['about-us','others','project','quote'])->paginate(30);
        }
