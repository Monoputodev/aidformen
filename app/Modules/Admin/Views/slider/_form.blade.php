...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="form-line">
                {!! Form::label('caption', 'Caption', array('class' => 'col-form-label')) !!}<span class="required"> *</span> 
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="form-line">
                {!! Form::label('short_order', 'Order', array('class' => 'col-form-label')) !!}<span class="required"> *</span>  <strong>(Plese enter number type data)</strong> 
