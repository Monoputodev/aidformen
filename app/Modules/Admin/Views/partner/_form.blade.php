    ...
    <div class="col-md-6">
        <div class="form-group">
            <div class="form-line">
                ...
                <a target="_blank" href="{{URL::to('')}}/uploads/partner/{{$data->image_link}}" style="margin-top: 5px;"
                  class="btn btn-primary btn-sm font-10"><img src="{{URL::to('')}}/uploads/partner/{{$data->image_link}}"
