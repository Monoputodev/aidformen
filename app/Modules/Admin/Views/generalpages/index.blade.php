                    ...
                    <tbody>
                       ...
                       @foreach($data as $values)
                           <tr>
                            ...
                            <td>
                                @if($values->tag=='about-us')
                                <a class="btn btn-info">{{ucfirst($values->tag)}}</a>

                                @elseif($values->tag=='mission')
                                <a class="btn btn-success">Mission & Vision</a>

                                @elseif($values->tag=='recent-activity')
                                <a class="btn btn-warning">Recent Activity</a>
                                @else
                                <a class="btn btn-secondary">{{ucfirst($values->tag)}}</a>
                                @endif
                            </td>
                            <td>{{$values->status}}</td>
                            <td>
