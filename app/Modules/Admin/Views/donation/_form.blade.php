...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            <div class="form-line">
                {!! Form::label('type', 'Bank Type', array('class' => 'col-form-label')) !!}<span class="required">
                    *</span>
                {!! Form::Select('type',array('1'=>'Physical Bank','2'=>'Mobile Banking','cancel' =>
                'Cancel'),Input::old('type'),['id'=>'type', 'class'=>'form-control selectheight']) !!}
