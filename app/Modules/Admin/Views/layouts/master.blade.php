			...
			<div class="container-fluid">
				<div class="navbar-header">
					...
					<a class="navbar-brand" style="color: white"
					  href="{{URL::to(config('global.prefix_name').'/dashboard')}}">{{__('messages.sitename')}} ::
						{{__('messages.dashboard')}} </a>
				</div>
				<div class="collapse navbar-collapse" id="navbar-collapse">
					<ul class="nav navbar-nav navbar-right">
						<li>
							<a type="button" target="__blank" href="{{URL::to('/')}}" class="btn btn-info"
							  onclick="return confirm('Are you sure to go home page ?')"
						...
						<li>
							<a type="button" href="{{ route('admin.user.password.reset', Auth::guard()->user()->id) }}"
							  class="btn btn-info" style="margin-top: 10px;height: 40px;background: #f44336;">
						...
						<li class="dropdown">
							<a href="javascript:void(0);" class="dropdown-toggle btn btn-info" data-toggle="dropdown"
							  role="button" style="margin-top: 10px;height: 40px;">
									...
									<ul class="menu">
										<li>
											<a href="{{ url('locale/en') }}">
												<div class="menu-info">
													<h4><img src="{{URL::to('flag/en.jpg')}}" class="img-circle"
														  alt=""><span style="margin-left: 5px;">English</span></h4>
												</div>
											</a>
										</li>
										<li>
											<a href="{{ url('locale/bn') }}">
												<div class="menu-info">
													<h4><img src="{{URL::to('flag/bn.jpg')}}" class="img-circle"
														  alt=""><span style="margin-left: 5px;">Bangla</span></h4>
												</div>
											</a>
										</li>
									</ul>
				...
				document.getElementById('logout-form').submit();" class="btn btn-danger"
							  style="margin-top: 10px;height: 40px;background: #f44336;">
								...
								<i class="material-icons">input</i><span>{{__('messages.Logout')}}</span>
							</a>
						</li>
					</ul>
				</div>
