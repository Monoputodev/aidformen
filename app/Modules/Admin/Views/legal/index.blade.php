...
<div class="block-header block-header-2">
    ...
    <a href="{{route('admin.legal.create')}}" class="btn btn-primary waves-effect pull-right">Add Legal Sponsor</a>
</div>
{!! Form::open(['method' =>'GET', 'route' => 'admin.legal.search', 'id'=>'', 'class' => '']) !!}
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <img width="50" height="50"
                                      src="{{URL::to('')}}/uploads/legal/{{$values->image_link}}">
                                    @endif
                                </td>
