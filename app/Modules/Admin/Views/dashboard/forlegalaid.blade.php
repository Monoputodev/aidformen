                    ...
                    <table class="table table-bordered table-striped table-hover dataTable js-basic-example">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(isset($values->nid_file) > 0 && !empty($values->nid_file))
                                    <img width="50" height="50" src="{{URL::to('')}}/uploads/forLegalAid/{{$values->nid_file}}">
                                    @endif
                                </td>
                                ...
                                <td>
                                    ...
                                    <img width="50" height="50" src="{{URL::to('')}}/uploads/forLegalAid/{{$values->image_link}}">
                                    @endif
                                </td>
                                <td>
                                    {{$values->status}}
