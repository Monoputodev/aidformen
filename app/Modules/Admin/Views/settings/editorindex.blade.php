  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
      <div class="body">
        ...
        {!! Form::open(['route' => 'admin.general.image.store',  'files'=> true, 'id'=>'general_file', 'class' => 'form-horizontal']) !!}
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="form-line">
                ...
                {!! Form::text('title',Input::old('title'),['id'=>'title','class' => 'form-control','required'=> 'required',  'title'=>'Enter Image Title']) !!}
     ...
     <div class="body">
      <div class="table-responsive">
        ...
        <table class="table table-bordered table-striped table-hover dataTable js-basic-example list-unstyled clearfix" id="aniimated-thumbnials">
          ...
          <td>
            @if($fileinfo !='logo.png' && $fileinfo !='short.cut.icon.png')
            <a href="{{ route('admin.general.image.destroy', $fileinfo) }}" class="demo-google-material-icon" onclick="return confirm('Are you sure to Delete?')" ><i class="material-icons">delete</i></a>
            @endif
