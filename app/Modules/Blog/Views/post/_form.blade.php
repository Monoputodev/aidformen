    ...
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          ...
          <div class="form-line">
            {!! Form::label('category_id', 'Select Category', array('class' => 'col-form-label')) !!} <span class="required"> *</span>
            {!! Form::Select('category_id', $parent_category_options ,Input::old('category_id'),['id'=>'category_id', 'class'=>'form-control selectheight']) !!}
      ...
      <div class="col-md-6">
        <div class="form-group">
          <div class="form-line">
            {!! Form::label('date', 'Post Date', array('class' => 'col-form-label')) !!}<span class="required"> *</span> 
     ...
     <div class="col-md-4">
        <div class="form-group">
          ...
          <div class="form-line">
           {!! Form::label('author', 'Author', array('class' => 'col-form-label')) !!} <span class="required"> *</span>
           {!! Form::text('author',Input::old('author'),['id'=>'author','class' => 'form-control','required'=> 'required', 'placeholder'=>'Enter author name' ]) !!}
    ...
    <div class="col-md-6">
      <div class="form-group">
        ...
        <div class="form-line">
          ...
          <a target="_blank" href="{{URL::to('')}}/uploads/blog/{{$data->image_link}}" style="margin-top: 5px;" class="btn btn-primary btn-sm font-10"><img src="{{URL::to('')}}/uploads/blog/200x200/{{$data->image_link}}" height="50px" alt="{{$data['image_link']}}" ></img>
          </a>
          @endif
        </div>
      </div> 
  ...
  $(function() {
            ...
            $("#categoryform").validate({
              ...
              messages:{
                ...
                category: 'Plese choose category',
